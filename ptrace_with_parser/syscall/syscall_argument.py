...
from ptrace_with_parser.ctypes_tools import uint2int, formatWordHex, formatAddress
from ptrace_with_parser.signames import signalName
from ctypes import c_int
from ptrace_with_parser.error import PTRACE_ERRORS, writeError
from logging import getLogger, INFO
from ptrace_with_parser.func_arg import FunctionArgument
from ptrace_with_parser.syscall.posix_arg import (
    formatMmapProt, formatAccessMode, formatOpenFlags, formatCloneFlags, formatDirFd, formatOpenMode)
from ptrace_with_parser.func_call import FunctionCall
...
from ptrace_with_parser.syscall.socketcall_constants import SOCKETCALL
import os
import re

from ptrace_with_parser.os_tools import RUNNING_LINUX, RUNNING_FREEBSD
from ptrace_with_parser.syscall import FILENAME_ARGUMENTS
from ptrace_with_parser.syscall.socketcall_constants import formatSocketType
if RUNNING_LINUX:
    from ptrace_with_parser.syscall.linux_struct import (
        timeval, timespec, pollfd, rlimit, new_utsname, user_desc)
    from ptrace_with_parser.syscall.linux_constants import SYSCALL_ARG_DICT, FD_SETSIZE
elif RUNNING_FREEBSD:
    from ptrace_with_parser.syscall.freebsd_constants import SYSCALL_ARG_DICT
else:
    SYSCALL_ARG_DICT = {}
