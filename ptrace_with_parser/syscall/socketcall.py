...
from ptrace_with_parser.ctypes_tools import ntoh_ushort, ntoh_uint  # noqa
from ptrace_with_parser.syscall import SYSCALL_PROTOTYPES
from ptrace_with_parser.syscall.socketcall_constants import SOCKETCALL, SOCKET_FAMILY  # noqa
from ptrace_with_parser.syscall.socketcall_struct import sockaddr, sockaddr_in, sockaddr_in6, sockaddr_un
from ctypes import c_int
from ptrace_with_parser.os_tools import RUNNING_LINUX
from socket import AF_INET, AF_INET6, inet_ntoa   # noqa
if RUNNING_LINUX:
    from socket import AF_NETLINK
    from ptrace_with_parser.syscall.socketcall_struct import sockaddr_nl
