...
try:
    ...
    try:
        ...
        DISTORM3 = False
        from ptrace_with_parser.pydistorm import Decode
        if CPU_X86_64:
            from ptrace_with_parser.pydistorm import Decode64Bits as DecodeBits
            MAX_INSTR_SIZE = 11
        elif CPU_I386:
            from ptrace_with_parser.pydistorm import Decode32Bits as DecodeBits
            MAX_INSTR_SIZE = 8
        else:
            raise ImportError("CPU not supported")
