...
from ptrace_with_parser.debugger import PtraceProcess, ProcessSignal
from ptrace_with_parser.binding import HAS_PTRACE_EVENTS
from time import sleep
if HAS_PTRACE_EVENTS:
    from ptrace_with_parser.binding.func import (
